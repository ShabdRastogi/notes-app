...
urlpatterns = [
  ...
  path('notes/<int:note_number>/',views.GetNoteApi.as_view(),name='get-note'),
  path('notes/update/<int:note_number>/',views.UpdateNoteApi.as_view(),name='update-note'),
  path('notes/delete/<int:note_number>/',views.DeleteNoteApi.as_view(),name='delete-note'),
